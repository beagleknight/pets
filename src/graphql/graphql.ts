...
export type Cat = {
  ...
  id: Scalars['ID'];
  isPetted: Scalars['Boolean'];
  name: Scalars['String'];
  pettedAt?: Maybe<Scalars['String']>;
};
...
export type CatsMutationsPetArgs = {
  id: Scalars['ID'];
};


export type CatsMutationsUpdateArgs = {
  id: Scalars['ID'];
...
export type GetCatQuery = { __typename?: 'Query', catsNamespace: { __typename?: 'CatsNamespace', cat?: { __typename?: 'Cat', id: string, name: string, color: string, pettedAt?: string | null, isPetted: boolean } | null } };

export type GetCatsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetCatsQuery = { __typename?: 'Query', catsNamespace: { __typename?: 'CatsNamespace', cats: Array<{ __typename?: 'Cat', id: string, name: string, pettedAt?: string | null, isPetted: boolean }> } };

export type PetCatMutationVariables = Exact<{
  id: Scalars['ID'];
}>;


export type PetCatMutation = { __typename?: 'Mutation', catsMutations: { __typename?: 'CatsMutations', pet: { __typename?: 'CatPayload', cat?: { __typename?: 'Cat', id: string, pettedAt?: string | null, isPetted: boolean } | null, errors: Array<{ __typename?: 'Error', message: string }> } } };
...
export type UpdateCatMutation = { __typename?: 'Mutation', catsMutations: { __typename?: 'CatsMutations', update: { __typename?: 'CatPayload', cat?: { __typename?: 'Cat', id: string, name: string } | null, errors: Array<{ __typename?: 'Error', message: string }> } } };
...
export const PetCatDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"PetCat"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"catsMutations"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"pet"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"cat"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"pettedAt"}},{"kind":"Field","name":{"kind":"Name","value":"isPetted"},"directives":[{"kind":"Directive","name":{"kind":"Name","value":"client"}}]}]}},{"kind":"Field","name":{"kind":"Name","value":"errors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}}]}}]} as unknown as DocumentNode<PetCatMutation, PetCatMutationVariables>;
export const UpdateCatDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateCat"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateCatInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"catsMutations"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"update"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"cat"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"errors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}}]}}]} as unknown as DocumentNode<UpdateCatMutation, UpdateCatMutationVariables>;
